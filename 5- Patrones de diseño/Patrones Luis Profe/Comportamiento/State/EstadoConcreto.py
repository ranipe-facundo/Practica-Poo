...
class ProductoAgotado(Estado): # Estado concreto 1 (Deberia estar en un archivo aparte)
...
class ProductoSeleccionado(Estado): # Estado concreto 2 (Deberia estar en un archivo aparte)
    def insertar_dinero(self, maquina):
...
class SinDinero(Estado): # Estado concreto 3 (Deberia estar en un archivo aparte)
    def insertar_dinero(self, maquina):
...
class ConDinero(Estado): # Estado concreto 4 (Deberia estar en un archivo aparte)
    def insertar_dinero(self, maquina):
