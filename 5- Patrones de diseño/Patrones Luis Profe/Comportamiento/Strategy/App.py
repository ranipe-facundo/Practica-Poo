...
tienda.set_estrategia_de_pago(PagoConTarjetaDeCredito("1234 5678 9876 5432", "Juan Pérez")) # seteo la estrategia deseada de pago, envio los parametros necesarios
tienda.pagar(100.0)
