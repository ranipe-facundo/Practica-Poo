import sys
from PyQt6.QtWidgets import QApplication, QDialog, QPushButton, QVBoxLayout, QLabel,QLineEdit
...
class SimpleDialog(QDialog):
    def __init__(self):
        ...
        layout.addWidget(QLabel("Agregue su texto"))

        # Establecer el layout para el diálogo
        self.setLayout(layout)
        
        # Crear un cuadro de texto para la entrada del usuario
    ...
    def on_ok_clicked(self):
        ...
        #layout2 = QVBoxLayout()
       # layout2.addWidget(QLabel("Esta es la nueva ventana."))
        pass
